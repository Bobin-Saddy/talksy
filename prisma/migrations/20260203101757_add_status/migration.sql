/*
  ...
  - You are about to drop the column `emailButtonBgColor` on the `ChatSettings` table. All the data in the column will be lost.
  - You are about to drop the column `heroBgColor` on the `ChatSettings` table. All the data in the column will be lost.
  - You are about to drop the column `heroTextColor` on the `ChatSettings` table. All the data in the column will be lost.
